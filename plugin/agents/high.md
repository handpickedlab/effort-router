---
name: high
description: "Delegated worker at high reasoning effort for standard implementation and bug fixes with a clear spec. effort-router's route tool says when to use it and which model to pass."
model: sonnet
effort: high
---
