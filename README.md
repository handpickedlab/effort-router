...
With a [TypeSafe](https://typesafe.ai) API key, Jev judges each task; without one, a built-in heuristic does. Put the key in `~/.config/effort-router/typesafe-api-key` (mode 600).
